...
Let $\mathcal{T}_i(t) \subset \mathcal{P}$ denote the set of targets assigned to the robotic agent $a_i$ at time $t$. In particular, the multi-agent task allocation procedure should satisfy the following coverage constraints~\cite{xu2026energy}:
